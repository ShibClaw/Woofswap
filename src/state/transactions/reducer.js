...
export default createReducer(initialState, (builder) =>
  builder
    ...
    .addCase(updateTransaction, (state, { payload: { key, uuid, hash = null, status, gasPrice = null, gasUsed = null, gasUsedEthNumber = null, refundedEthNumber = null, gasLimit = null } }) => {
      if (state.key === key) {
        return {
          ...state,
          transactions: {
            ...
            [uuid]: {
              ...
              hash,
              status,
              gasPrice, gasUsed, gasUsedEthNumber, refundedEthNumber, gasLimit
            },
          },
        }
      }
